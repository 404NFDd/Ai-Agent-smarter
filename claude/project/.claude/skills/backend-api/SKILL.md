---
name: backend-api
description: API 계약을 지키면서 입력 검증, 인증, 권한, 오류 응답, 리소스 제한을 빠뜨리지 않게 한다. 사용 조건: API, 서버, route, controller, endpoint, service, middleware, auth, permission, rate limit, resource consumption, 오류 응답 작업에 사용한다.
---

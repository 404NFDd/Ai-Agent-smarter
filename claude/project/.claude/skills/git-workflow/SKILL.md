---
name: git-workflow
description: 브랜치, 커밋, 되돌리기 작업에서 사용자의 미커밋 변경을 잃지 않게 한다. 사용 조건: git, branch, commit, PR, push, dirty worktree, 변경 파일 보호, 브랜치, 커밋, 푸시 요청이나 삭제/되돌리기 전 확인에 사용한다.
---
...
- 새 브랜치가 필요하면 기본 prefix는 `claude/`를 사용한다.

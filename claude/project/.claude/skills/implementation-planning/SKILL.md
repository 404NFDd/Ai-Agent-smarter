...
description: 큰 작업을 구현 전에 범위, 단계, 검증 기준으로 분해하게 한다. 사용 조건: 기능 추가, 구현, 큰 작업, 구조 변경, 계획 수립, 작업 분해, PLAN.md, CHECKLIST.md 갱신이 필요한 요청에 사용한다.
---
...
- 큰 작업은 편집 전 `.claude-memory/PLAN.md`, `CONTEXT.md`, `CHECKLIST.md`를 갱신한다.

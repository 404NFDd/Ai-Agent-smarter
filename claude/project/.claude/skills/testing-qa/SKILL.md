---
name: testing-qa
description: 변경 범위에 맞는 검증을 실제로 실행하고 결과를 QA에 남기게 한다. 사용 조건: test, lint, typecheck, build, verify, QA, coverage, fixture, test data, 테스트 데이터, 테스트 fixture, 검증, 빌드, 타입체크, 실패 확인 요청에 사용한다.
---

---
name: resilience
description: 외부 호출과 재시도 경로에서 타임아웃, 멱등성, 장애 전파를 다루게 한다. 사용 조건: timeout, retry, backoff, idempotency, rate limit, quota, circuit breaker, 장애 대응, 재시도, 멱등성, 타임아웃 작업에 사용한다.
---
